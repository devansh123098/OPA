        ...
        <div className="md:col-span-8 lg:col-span-9 text-center md:text-left">
          <AnimatedSection animationClass="animate-fadeInUp">
            ...
            <p className="mt-4 text-xl text-muted-foreground max-w-2xl mx-auto md:mx-0">
              Check out the latest player rankings in various categories.
            </p>
          </AnimatedSection>
        </div>
      ...
      <AnimatedSection delay={100} animationClass="animate-fadeInUp">
        <Card className="shadow-lg">
          <CardHeader className="flex flex-row items-center gap-3">
            ...
            <CardTitle className="text-2xl">Rankings Coming Soon!</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-lg">
              We are currently working on compiling and updating the official player rankings. 
